...
<div class="container-1200 align-row space-around">
   ...
   <div class="icon-area align-row">
      <a class="icon-item align-column" href="#">
         <img class ="icon" src="<%=request.getContextPath()%>/image/like.svg">
         <span>좋아요</span>
      </a>
      <a class="icon-item align-column" href="#">
         <img class ="icon" src="<%=request.getContextPath()%>/image/bag.svg">
         <span>장바구니</span>
      </a>
      <a class="icon-item align-column" href="#">
         <img class ="icon" src="<%=request.getContextPath()%>/image/writing.svg">
         <span>리뷰</span>
      </a>
      <a  class="icon-item align-column" href="#">
         <img class ="icon" src="<%=request.getContextPath()%>/image/gift.svg">
         <span>이벤트</span>
      </a>
   </div>
