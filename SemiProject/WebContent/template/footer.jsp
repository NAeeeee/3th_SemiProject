...
<div style="background-color: black;width: 100%; ">
   <div class="container-1200" style="margin: 0 auto;padding:2rem 0 5rem 0;">
      <h5 style="color:white;margin-bottom: 20px">ABOUT US</h5>
      <p style="color:white;font-size: 12px;margin-bottom: 10px">상호:BOOKin | 사업장소재지:서울특별시 영등포구 | 안내전화:1588-XXXX | 대표이사:전수현 | 제휴/광고문의:soo4767@naver.com | 사업자등록번호:XXX-XX-XXXXX | 통신판매업 신고번호:XXXX-서울영등포구-XXXX</p>
