...
public class BookInsertServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			bookDto.setBookAutor(req.getParameter("book_autor"));
			...
			bookDto.setBookPubdate(req.getParameter("book_pubdate"));
			bookDto.setBookGenre(Integer.parseInt(req.getParameter("book_genre")));
